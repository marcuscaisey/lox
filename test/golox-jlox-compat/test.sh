...
# Our Lox flavour allows super without a following .
rm -f test/super/super_without_dot.lox
# Expecting different parser errors than golox raises
rm -f test/for/fun_in_body.lox
rm -f test/for/statement_condition.lox
rm -f test/for/statement_increment.lox
...
rm -f test/super/parenthesized.lox
rm -f test/super/super_without_name.lox
