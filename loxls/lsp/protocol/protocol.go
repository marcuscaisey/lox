// Code generated by "typegen initialize initialized shutdown exit textDocument/didOpen textDocument/didChange textDocument/didClose textDocument/publishDiagnostics textDocument/formatting window/logMessage"; DO NOT EDIT.
package protocol
...
type FormattingOptions struct {
	...
	//
	// @since 3.15.0
	TrimTrailingWhitespace *Boolean `json:"trimTrailingWhitespace,omitempty"`
	// Insert a newline character at the end of the file if one does not exist.
	//
	// @since 3.15.0
	InsertFinalNewline *Boolean `json:"insertFinalNewline,omitempty"`
	// Trim all newlines after the final newline at the end of the file.
	//
	// @since 3.15.0
	TrimFinalNewlines *Boolean `json:"trimFinalNewlines,omitempty"`
}
