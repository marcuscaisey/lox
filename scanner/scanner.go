...
func (e *syntaxError) Error() string {
	return fmt.Sprintf("%d:%d: syntax error: %s", e.Line, e.Byte, e.Msg)
}
...
// syntaxErrorf returns a syntaxError with its Line and Byte set based on the current state of the Scanner.
