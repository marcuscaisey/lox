...
- Remove references to metaclass from error messages.
- Stop crash when forward declared class is used.
...
- Fix crash when opening `built_ins.lox`.
- Resolve property of "this" or class to property setter if it exists.

## [4.2.0] - 2026-01-18

### Added

- Report errors for unresolved properties.

### Fixed

- Refer to object properties consistently in error messages.
- Show error for static init() method.
...
- Add support for usage of the 'super' keyword.
...
[Unreleased]: https://github.com/marcuscaisey/lox/compare/vscode-lox/v4.4.0...HEAD
[4.4.0]: https://github.com/marcuscaisey/lox/compare/vscode-lox/v4.4.0...HEAD
[4.3.0]: https://github.com/marcuscaisey/lox/tree/vscode-lox/v4.2.0/vscode-lox
[4.2.0]: https://github.com/marcuscaisey/lox/tree/vscode-lox/v4.2.0/vscode-lox
